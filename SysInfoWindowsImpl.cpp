...
SysInfoWindowsImpl::SysInfoWindowsImpl() : SysInfo(), _cpuLoadLastValues() {}

void SysInfoWindowsImpl::init() { _cpuLoadLastValues = cpuRawData(); }

double SysInfoWindowsImpl::cpuLoadAverage() {
  QVector<qulonglong> firstSample = _cpuLoadLastValues;
